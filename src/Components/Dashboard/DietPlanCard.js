...
export function MacrosPlanCard() {
  ...
  const rows = [
    { id: 1, key: "Total calories", value: state.TDEE + "cal", red: true },
  ...
  return (
    <div style={{ grid: "span 1" }} className="macros-card">
        ...
        {rows2.map((el) => (
          <p
            style={{
              ...
              alignItems: "center",
              borderRadius: "10px",
              border: "1px solid rgba(218, 10, 10, 0.64)",
              color: el.yellow
                ? "yellow"
                : el.blue
                  ? "rgb(55, 15, 214)"
...
const meals = {
  breakfast: {
    ...
    foods: [
      ...
      { id: 4, name: "Greek Yogurt", calories: 59,  protein: 10, carbs: 4,  fats: 0  },
  ...
  lunch: {
    ...
    foods: [
      ...
      { id: 2, name: "Brown Rice",     calories: 216, protein: 5,  carbs: 45, fats: 2 },
      { id: 3, name: "Broccoli",       calories: 55,  protein: 4,  carbs: 11, fats: 1 },
      { id: 4, name: "Sweet Potato",   calories: 86,  protein: 2,  carbs: 20, fats: 0 },
  ...
  dinner: {
    ...
    foods: [
      ...
      { id: 4, name: "Turkey Breast", calories: 135, protein: 30, carbs: 0,  fats: 1  },
        ...
        {macros.map((el) => (
          <p
            ...
            style={{
              ...
              borderRadius: "10px",
              border: "1px solid rgba(218, 10, 10, 0.64)",
              color: el.yellow ? "yellow" : el.blue ? "rgb(55, 15, 214)" : "red",
              fontSize: "12px",
              flexDirection: "column",
              gap: "3px",
            }}
...
export function MealPlan() {
  return (
    <>
      <MealCard title="Breakfast" percentage={meals.breakfast.calories} foods={meals.breakfast.foods} />
      <MealCard title="Lunch"     percentage={meals.lunch.calories}     foods={meals.lunch.foods}     />
      <MealCard title="Dinner"    percentage={meals.dinner.calories}    foods={meals.dinner.foods}    />
    </>
  );
}